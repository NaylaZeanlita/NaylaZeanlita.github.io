            ...
            <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
                ...
                <div class="form-group">
                    ...
                    <select id="category" name="category" required>
                        ...
                        <option value="Jalan" <?php if ($recommendation['Category'] == 'Jalan') echo 'selected'; ?>>Jalan</option>
                        <option value="Jembatan" <?php if ($recommendation['Category'] == 'Jembatan') echo 'selected'; ?>>Jembatan</option>
                        <option value="Infrastruktur Lainnya" <?php if ($recommendation['Category'] == 'Infrastruktur Lainnya') echo 'selected'; ?>>Infrastruktur Lainnya</option>
                    </select>
                </div>
