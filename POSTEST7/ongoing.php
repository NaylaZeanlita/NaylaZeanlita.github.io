...
$sql = mysqli_query($conn, "SELECT*FROM ongoingproject");
$ongoingresult = [];
...
if (isset($_GET['search'])) {
    ...
    $sql = mysqli_query($conn, "SELECT * FROM ongoingproject WHERE 'nama proyek' LIKE '%$search%' OR
...
<body>
    <div class="layer2">
        ...
        <table class="review-table">
            <thead>
                <tr>
                    <th colspan="5">ONGOING PROJECT</th>
                </tr>
                <tr>
                    <th colspan="5">
            ...
            <tbody>
                <?php $i = 1; foreach($ongoingresult as $ongoingproject) : ?>
                    <tr>
                        <td><?php echo $ongoingproject['id'] ?></td>
                        <td><?php echo $ongoingproject['nama proyek'] ?></td>
                        <td><?php echo $ongoingproject['category'] ?></td>
                        <td><?php echo $ongoingproject['lokasi'] ?></td>
                        <td><?php echo $ongoingproject['status'] ?></td>
                    </tr>
                <?php $i++; endforeach ?>
            </tbody>
        </table>   
