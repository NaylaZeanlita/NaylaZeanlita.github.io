...
$sql = mysqli_query($conn, "SELECT*FROM materialproject");
$materialresult = [];
...
if (isset($_GET['search'])) {
    ...
    $sql = mysqli_query($conn, "SELECT * FROM materialproject WHERE 'nama proyek' LIKE '%$search%' OR
...
<body>
    <div class="layer2">
        ...
        <table class="review-table">
            <thead>
                <tr>
                    <th colspan="5">MATERIAL PROJECT</th>
                </tr>
                <tr>
                    <th colspan="5">
            ...
            <tbody>
                <?php $i = 1; foreach($materialresult as $materialproject) : ?>
                    <tr>
                        <td><?php echo $materialproject['id'] ?></td>
                        <td><?php echo $materialproject['nama proyek'] ?></td>
                        <td><?php echo $materialroject['category'] ?></td>
                        <td><?php echo $materialproject['material'] ?></td>
                        <td><?php echo $materialproject['qty'] ?></td>
                    </tr>
                <?php $i++; endforeach ?>
            </tbody>
        </table>   
